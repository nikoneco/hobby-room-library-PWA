...
let lastResult = null;
let lastResultKind = 'none'; // 'search' | 'random' | 'shelf' | 'none'
let resultRequestGeneration = 0;
let currentSearchResultPresentationStats = null;
...
let bookDetailPersistentSaveTimer = 0;
let currentDatasetRevision = '';
let bookDetailRequestGeneration = 0;
...
let searchResultDetailPrefetchSource = null;
let searchResultDetailPrefetchKind = 'none';
let searchResultDetailPrefetchTimer = 0;
let searchResultDetailPrefetchIdleTimer = 0;
let searchResultDetailPrefetchGeneration = 0;
let bookshelfScrollSaveTimer = 0;
let shelfRenderRunId = 0;
let shelfRenderInProgress = false;
let shelfJumpGeneration = 0;
let pendingShelfJump = null;
let resultRenderRunId = 0;
let resultRenderObserver = null;
...
const BOOK_DETAIL_PERSISTENT_CACHE_KEY = 'shumiLibrary.bookDetailCache.v2';
const BOOK_DETAIL_PERSISTENT_CACHE_LIMIT = 240;
const BOOK_DETAIL_PERSISTENT_CACHE_TTL_MS = 7 * 24 * 60 * 60 * 1000;
const BOOK_DETAIL_PERSISTENT_SAVE_DELAY_MS = 250;
const BOOK_DETAIL_REQUEST_TIMEOUT_MS = 25000;
const BOOK_DETAIL_PREFETCH_QUEUE_LIMIT = 40;
const BOOK_DETAIL_PREFETCH_BATCH_SIZE = 12;
...
const SEARCH_RESULT_DETAIL_PREFETCH_DELAY_MS = 360;
const SEARCH_RESULT_DETAIL_PREFETCH_TIMEOUT_MS = 1500;
...
const RESULT_RENDER_INITIAL_BOOK_LIMIT = 12;
const RESULT_RENDER_CARD_CHUNK_SIZE = 12;
const RESULT_RENDER_LIST_CHUNK_SIZE = 20;
...
const BOOKSHELF_CACHE_KEY = 'shumiLibrary.bookshelfLiteCache.v2';
