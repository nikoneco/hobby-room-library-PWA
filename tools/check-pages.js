...
assert(index.includes('name="theme-color" content="#07161a"'), 'static index uses shinhaku PWA theme color');
...
assert(index.includes('html{background:#07161a'), 'critical style paints shinhaku shell before CSS loads');
...
assert(manifest.theme_color === '#07161a', 'manifest theme color matches shinhaku app shell');
assert(manifest.background_color === '#07161a', 'manifest splash background matches shinhaku app shell');
