...
function fetchDeferredBookDetails_(book, index, dataArr, seriesContext) {
  if (!shouldFetchDeferredBookDetails_(book)) return;
  ...
  google.script.run
    ...
    .withFailureHandler(function(err) {
      console.warn('getBookDetailByRowIndex failed:', err);
      book.detailLoading = false;
      book.detailError = '詳細データを取得できませんでした。';
    })
