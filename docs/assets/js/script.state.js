...
const BOOK_DETAIL_PREFETCH_QUEUE_LIMIT = 72;
const BOOK_DETAIL_PREFETCH_BATCH_SIZE = 12;
const BOOK_DETAIL_PREFETCH_WARM_LIMIT = 24;
const BOOK_DETAIL_PREFETCH_CONCURRENCY = 2;
const POPUP_DETAIL_PREFETCH_RADIUS = 3;
